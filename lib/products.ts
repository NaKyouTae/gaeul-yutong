...
const categoryImageIndices: Record<string, number[]> = {
  ...
  '대게/홍게': [0, 4, 17, 33], // 홍게 다리(0), 대방어(4), 간장게장(17), 게장세트(33)
  '수산물': [1, 2, 5, 6, 7, 9, 12, 13, 14, 15, 16, 18, 19, 20, 21, 23, 24, 25, 26, 27, 28, 29, 32, 40, 41, 48, 50, 51, 52, 53, 57, 58, 59, 73], // 일반 수산물: 새조개(1), 바지락(2), 갈치(5), 새꼬막(6), 굴(7), 홍가리비(9), 전복(12,13), 멍게(14), 피홍합(15), 물미역(16), 활전복(18), 갈치(19), 게장(20), 과메기(21), 추어탕(23,24), 전복(25,26,27), 새우(28), 물미역(29), 갈치(32), 밥식해(40), 된장콩잎(41), 새우(48), 새우(50), 참치(51), 추어탕(52,53), 전복(57,58), 장어(59), 홍어(73)
  ...
  '문어/낙지/쭈꾸미': [22, 30, 31, 36, 39, 49, 55, 56, 64, 65], // 손질오징어(22), 손질 문어(30), 활 문어(31), 마른오징어(36), 오징어채(39), 산낙지(49), 오징어 백진미(55), 오징어 피데기(56), 오징어구이(64), 오징어 피데기(65)
  '명절 선물세트': [32, 33, 63, 68, 69, 73], // 게장세트(32), 과메기세트(33), 생선세트(63), 꿀(68), 곶감세트(69), 김선물세트(73)
};
